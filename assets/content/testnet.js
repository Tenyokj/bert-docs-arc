export const testnetDocs = [
  {
    ...
    content: `
      ...
      <p class="lead">BERT is currently operating on Arc Testnet while the protocol, frontend, backend and indexers are hardened before any mainnet launch. The contracts are deployed and transactions are real testnet transactions. Testnet USDC, balances, rewards and outcomes have no monetary value. V2 currently runs the BERT V2.2 conditional-pledge model: target-backed proposals, a 5% successful-round fee snapshot and pull-based pledge refunds.</p>
      ...
      <h2>Safe test flow</h2><ol class="numbered-flow"><li>Connect a wallet configured for Arc Testnet and obtain only test assets.</li><li>Open Profile and activate Demo verification. Confirm the onchain transaction.</li><li>For V2, submit a target-backed funding proposal, then test one focused pledge/refund, settlement or milestone path. The first new round needs 30 configured pending proposals.</li><li>For V3, test one focused Community lifecycle path.</li><li>Capture transaction hash, wallet, network, expected result and actual result. For a suspected vulnerability, stop at minimum proof of impact and report it privately.</li></ol>
...
// The frontend then submits the backend-signed payload to PoPVerifier onchain.</code></pre>
  ...
  },
  {
    ...
    content: `
      ...
      <p class="lead">The table below is the current Arc Testnet integration release, updated for the BERT V2.2 conditional-pledge proxy upgrade on 2026-09-21. It contains the stable public proxy addresses a developer can call. Implementation and ProxyAdmin metadata remains in the versioned core deployment manifest for audit and operations, not in this integration table.</p>
      ...
      <table><thead><tr><th>Contract</th><th>Call address</th><th>Use</th></tr></thead><tbody><tr><td>IdeaRegistryUpgradeable</td><td><code>0xE6563acfdc194Ba3861EfD928Bd8B1B33a5D29d5</code></td><td>BERT V2.2 funding proposals, author bonds, targets and lifecycle state.</td></tr><tr><td>FundingPoolUpgradeable</td><td><code>0x5eDdccd772a9E0F079cC6646b529C20e3D46e585</code></td><td>V2 pledge escrow, refunds, reserve and V3 Factory configuration.</td></tr><tr><td>VotingSystemUpgradeable</td><td><code>0xD008fC96902A9680FF77305881Ad6C6C075e7a68</code></td><td>Global BERT V2.2 rounds, viability selection and pledge entrypoint.</td></tr><tr><td>GrantManagerUpgradeable</td><td><code>0xA110baB4562d59d8bb7eDA4a05E53F40c678ccB2</code></td><td>Net grant claim, expiry/cancellation and milestone review entrypoint.</td></tr><tr><td>VoterProgressionUpgradeable</td><td><code>0xF6EB65957bb5e363FCD6B84AAdf76E41Ba754E14</code></td><td>Voter progression, levels and winning-participation state.</td></tr><tr><td>ReputationSystemUpgradeable</td><td><code>0x3594C46983460733F6470f7b61De2f3bB2918a81</code></td><td>Contributor reputation initialization and outcome updates.</td></tr></tbody></table>
      ...
      <table><thead><tr><th>Anchor</th><th>Value</th><th>Why indexers and operators need it</th></tr></thead><tbody><tr><td>V3 Factory deployment block</td><td><code>61277385</code></td><td>Start V3 Factory event indexing here, not at block zero.</td></tr><tr><td>FundingPool V3 configuration transaction</td><td><code>0x64f72f6faa86dab29a674a8da8ded1e4440661f31e15d16a1f966f33530e0dd8</code></td><td>Auditable record linking FundingPool to the V3 Factory release.</td></tr><tr><td>BERT V2.2 FundingPool proxy upgrade</td><td><code>0x465b5990d3cfcb6e625dd0af827fc999efdc9ce6662cfb764550c6332d48f191</code></td><td>Introduced conditional pledges, fee snapshots and refund accounting.</td></tr><tr><td>BERT V2.2 IdeaRegistry proxy upgrade</td><td><code>0xb05fa626d8ff2269af8def9a0c177f24cdc0463c5ea13deff6f3eb8bb01c910c</code></td><td>Introduced minimum net targets and legacy migration boundary.</td></tr><tr><td>BERT V2.2 VotingSystem proxy upgrade</td><td><code>0xb85eb09dde8f18f3b74f849882bbef2c9a62fe2edc7c717d6db085732afef02b</code></td><td>Introduced viable-winner selection after fee.</td></tr><tr><td>BERT V2.2 GrantManager proxy upgrade</td><td><code>0xeb24eae573ace96cba517f81f992cdf1dacdcdcd4cca07ced3f6fb764eea7cb0</code></td><td>Introduced claim expiry and incomplete-grant refund routes.</td></tr></tbody></table>
...
NEXT_PUBLIC_SUBGRAPH_URL=https://api.studio.thegraph.com/query/1742046/bert-arc-testnet/v0.2.1
